...
{
  ist[0] = map(SensVal[0], 150, 900, 400, 3000);//  drehen
  ist[1] = map(SensVal[1], 900, 100, 400, 3000);// Schulter
  ist[2] = map(SensVal[2], 120, 860, 400, 3000);// Hand
  ist[3] = map(SensVal[3], 900, 0, 400, 3000);// Zange
